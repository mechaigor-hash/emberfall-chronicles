...
A Python-based retro fantasy RPG: tiny ASCII dungeons, turn-based combat, treasure, shrines, save/load, and deterministic simulation for tests and CI.
...
You are **Kalidor**, a blade-bearing wanderer trapped under Emberfall Keep. Explore the maze, fight monsters, find relics, heal at shrines, and reach the ember gate (`>`).
...
- richer monster AI and patrol movement
